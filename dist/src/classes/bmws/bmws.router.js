...
// Car Instance
router.post("/bmws/admin/car/instance/create", adminController.createCarInstance);
router.delete("/bmws/admin/car/instance/delete", adminController.deleteCarInstance);
router.get("/bmws/admin/car/instances/all", adminController.getAllCarsInstances);
// Box
router.post("/bmws/admin/box/create", adminBoxController.createBox);
router.get("/bmws/admin/box", adminBoxController.getBox);
// Box Inside
router.post("/bmws/admin/box/inside/create", adminController.createBoxInsideInstance);
// Boxes
